 ...
 * Displays confirmation details after order has been failed due to some reason.
 * 
...
<?php
  ...
  // remove cart data due to failure of payment.
  unset($_SESSION['cart']);
?>
...
<?php
/**
 * require the html_defined text for checkout failure
 */
  require($define_page);
?>
</div>
