...
if (isset($_GET['action']) && ($_GET['action'] == 'update')) {
  ...
  if ($notify_string == 'action=notify&') {
      zen_redirect(zen_href_link('checkout_error', '', 'SSL'));
  } else {
...
// this uses the SESSION orders_id, or if doesn't exist, grabs most recent order # for this cust.
...
//-->
  ...
  echo "\n" . '<form action="' . zen_href_link('checkout_error', zen_get_all_get_params(array('action')), 'SSL', false) . '" method="post" name="formpost" />' . "\n";
  reset($_POST);
