...
define('NAVBAR_TITLE_2', 'Failure');

define('HEADING_TITLE', 'Your payment has been failed due to some reason.');
...
define('TEXT_CHECKOUT_LOGOFF_CUSTOMER', 'Sorry for the inconvenience. Please contact site admin and/or click the Log Off link to ensure that your receipt and purchase information is not visible to the next person using this computer.');
